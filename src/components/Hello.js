...
export const Hello = () => {
    return<div className="greetings-div">
        ...
        <section className="about">
            <p>I am Randall Thomas, the creator and writer of DeeDee's Recipes- where every recipe has a memory and every memory deserves a place to be told.</p>
            <p>First, allow me to say thank you for checking out my (NSS front-end capstone) work and I hope you find everything up to your standards- if not, feel free to email me at thesingingdev@gmail.com with suggestions, or feel free to fork my github repository and make the changes yourself and then send me a PR.</p>
